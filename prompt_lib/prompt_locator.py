...
CREATE_ANALYSTS_PROMPT = jinja_env.from_string("""
    ...
    Your are tasked with creating a set of AI analyst personas. Follow the below instructions carefully:

    1. Firstly review the research topic:
        {% if topic %}
            {{ topic }}
        {% else %}
    ...
    3. Determine the most interesting themes based upon the documents and/or feedback above.globals=
